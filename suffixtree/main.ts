...
let largeTest : string =  '   S’io credesse che mia risposta fosse   #'  +
...
let kcfaTest : string =  '   !lang typed/racket/base  #'  +
 '     #'  +
...
// the following all run to completion
