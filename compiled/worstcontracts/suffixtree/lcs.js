...
(function (LCS) {
    ...
    function pathLabel(node) {
        $rt_addContract(node, c1919ec94bf6e77835438f19b15184bdbc, "lcs.ts(6,28)");
    ...
    function longestCommonSublabel(label1, label2) {
        $rt_addContract(label2, cec88372874868d65bd05d6a88c713cddc, "lcs.ts(29,52)");
        var label1Marks = {};
        var label2Marks = {};
        ...
        if ((label1.length() == 0) || (label2.length() == 0)) {
            ...
            var ret = $rt_addContract(main(), cec88372874868d65bd05d6a88c713cddc, "lcs.ts(83,35)");
            return ret;
        }
    }
