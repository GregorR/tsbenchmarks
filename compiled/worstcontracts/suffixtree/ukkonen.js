...
function c2839b3456f3a5d82b088b55466df898cf() {
    if (typeof c2839b3456f3a5d82b088b55466df898c !== "undefined")
        return c2839b3456f3a5d82b088b55466df898c;
    var co = $ir_contract_for("object");
    var c = co;
    c = $ir_contract_oblige_member(c, "0", co);
    c = $ir_contract_oblige_member(c, "1", co);
    c = $ir_contract_oblige_member(c, "length", co);
    c2839b3456f3a5d82b088b55466df898c = c;
    $ir_contract_oblige_member(c, "0", c1919ec94bf6e77835438f19b15184bdbf());
    $ir_contract_oblige_member(c, "1", c151a835ceacdb11090d1960ae92771fe);
    $ir_contract_oblige_member(c, "length", c151a835ceacdb11090d1960ae92771fe);
    return c;
}
var c2839b3456f3a5d82b088b55466df898c;
if (typeof c2839b3456f3a5d82b088b55466df898c === "undefined")
    c2839b3456f3a5d82b088b55466df898c = c2839b3456f3a5d82b088b55466df898cf();
$ir_obj_def_const(this, "c2839b3456f3a5d82b088b55466df898cc", c2839b3456f3a5d82b088b55466df898c, true);
...
(function (Ukkonen) {
    ...
    function skipCountHelper(node, label, k, N) {
        $rt_addContract(node, c1919ec94bf6e77835438f19b15184bdbc, "/home/gkrichar/research/projects/ongoing/vm-gradual-typing/tsbenchmarks/compiled/worstcontracts/suffixtree/ukkonen.ts(6,34)");
        $rt_addContract(label, cec88372874868d65bd05d6a88c713cddc, "/home/gkrichar/research/projects/ongoing/vm-gradual-typing/tsbenchmarks/compiled/worstcontracts/suffixtree/ukkonen.ts(6,49)");
        $rt_check(k, "number");
        $rt_check(N, "number");
    ...
    function skipCount(node, label) {
        $rt_addContract(node, c1919ec94bf6e77835438f19b15184bdbc, "/home/gkrichar/research/projects/ongoing/vm-gradual-typing/tsbenchmarks/compiled/worstcontracts/suffixtree/ukkonen.ts(26,28)");
        $rt_addContract(label, cec88372874868d65bd05d6a88c713cddc, "/home/gkrichar/research/projects/ongoing/vm-gradual-typing/tsbenchmarks/compiled/worstcontracts/suffixtree/ukkonen.ts(26,43)");
        var ll = label.length();
        return skipCountHelper(node, label, 0, ll);
    }
    function jumpToSuffix(node) {
        $rt_addContract(node, c1919ec94bf6e77835438f19b15184bdbc, "/home/gkrichar/research/projects/ongoing/vm-gradual-typing/tsbenchmarks/compiled/worstcontracts/suffixtree/ukkonen.ts(30,31)");
    ...
    function tryToSetSuffixEdgeBang(fromNode, toNode) {
        $rt_addContract(fromNode, c1919ec94bf6e77835438f19b15184bdbc, "/home/gkrichar/research/projects/ongoing/vm-gradual-typing/tsbenchmarks/compiled/worstcontracts/suffixtree/ukkonen.ts(49,41)");
        $rt_addContract(toNode, c1919ec94bf6e77835438f19b15184bdbc, "/home/gkrichar/research/projects/ongoing/vm-gradual-typing/tsbenchmarks/compiled/worstcontracts/suffixtree/ukkonen.ts(49,60)");
    ...
    function findNextExtensionPointAndAddSuffixLinkBang(node, label, initialI, j) {
        $rt_addContract(node, c1919ec94bf6e77835438f19b15184bdbc, "/home/gkrichar/research/projects/ongoing/vm-gradual-typing/tsbenchmarks/compiled/worstcontracts/suffixtree/ukkonen.ts(54,61)");
        $rt_addContract(label, cec88372874868d65bd05d6a88c713cddc, "/home/gkrichar/research/projects/ongoing/vm-gradual-typing/tsbenchmarks/compiled/worstcontracts/suffixtree/ukkonen.ts(54,76)");
        $rt_check(initialI, "number");
        $rt_check(j, "number");
        //
        ...
        var suffixNode = $rt_addContract(tmp[0], c1919ec94bf6e77835438f19b15184bdbc, "/home/gkrichar/research/projects/ongoing/vm-gradual-typing/tsbenchmarks/compiled/worstcontracts/suffixtree/ukkonen.ts(67,39)");
        ...
        var loopGeneral = function (i, firstShot) {
            if (i >= N) {
                ...
                var tmp_1 = $rt_addContract(skipCountHelper(suffixNode, label, K, i), c2839b3456f3a5d82b088b55466df898cc, "/home/gkrichar/research/projects/ongoing/vm-gradual-typing/tsbenchmarks/compiled/worstcontracts/suffixtree/ukkonen.ts(107,50)");
    ...
    function extendAtPointBang(anode, aoffset, alabel, ai) {
        $rt_check(aoffset, "number");
        $rt_addContract(alabel, cec88372874868d65bd05d6a88c713cddc, "/home/gkrichar/research/projects/ongoing/vm-gradual-typing/tsbenchmarks/compiled/worstcontracts/suffixtree/ukkonen.ts(135,64)");
        $rt_check(ai, "number");
    ...
    function suffixTreeAddBang(tree, label) {
        $rt_addContract(tree, c039618a25fe49bc46e3571a10332d667c, "/home/gkrichar/research/projects/ongoing/vm-gradual-typing/tsbenchmarks/compiled/worstcontracts/suffixtree/ukkonen.ts(159,43)");
        $rt_addContract(label, cec88372874868d65bd05d6a88c713cddc, "/home/gkrichar/research/projects/ongoing/vm-gradual-typing/tsbenchmarks/compiled/worstcontracts/suffixtree/ukkonen.ts(159,62)");
            ...
            if (j < N) {
                ...
                if (typeof iStar != "boolean") {
                    if ((typeof nextExtensionNode != "boolean") &&
                        ...
                        var newActiveNode = $rt_addContract(extendAtPointBang(nextExtensionNode, nextExtensionOffset, label, iStar), c1919ec94bf6e77835438f19b15184bdbc, "/home/gkrichar/research/projects/ongoing/vm-gradual-typing/tsbenchmarks/compiled/worstcontracts/suffixtree/ukkonen.ts(172,58)");
        ...
        var addFirstSuffixBang = function (tree, label) {
            ...
            var res = $rt_addContract(tree.root.nodeFollowK(label, matchedAtNode, matchedInNode, mismatchedAtNode, mismatchedInNode), c2839b3456f3a5d82b088b55466df898cc, "/home/gkrichar/research/projects/ongoing/vm-gradual-typing/tsbenchmarks/compiled/worstcontracts/suffixtree/ukkonen.ts(202,46)");
            return res;
        };
