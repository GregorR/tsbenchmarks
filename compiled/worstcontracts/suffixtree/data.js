...
(function (Data) {
    var Label = (function () {
        ...
        Label.prototype.simpleToString = function () {
            $rt_addContract(this, cec88372874868d65bd05d6a88c713cddc, "data.ts(19,14)");
            return this.datum.substring(this.i, this.j);
        };
        Label.prototype.actualToString = function () {
            $rt_addContract(this, cec88372874868d65bd05d6a88c713cddc, "data.ts(22,14)");
            return '['
                + ' datum: ' + this.datum
                + ', i: ' + this.i
                + ', j: ' + this.j
        ...
        Label.prototype.length = function () {
            $rt_addContract(this, cec88372874868d65bd05d6a88c713cddc, "data.ts(29,14)");
            return this.j - this.i;
        };
        Label.prototype.labelRef = function (k) {
            $rt_addContract(this, cec88372874868d65bd05d6a88c713cddc, "data.ts(32,14)");
            $rt_check(k, "number");
        ...
        Label.prototype.sublabel = function (start, end) {
            ...
            $rt_addContract(this, cec88372874868d65bd05d6a88c713cddc, "data.ts(35,14)");
        ...
        Label.prototype.sublabelBang = function (start, end) {
            if (end === void 0) { end = undefined; }
            $rt_addContract(this, cec88372874868d65bd05d6a88c713cddc, "data.ts(47,14)");
            $rt_check(start, "number");
            $rt_check(end, "number");
            if (end == undefined) {
        ...
        Label.prototype.isPrefix = function (otherLabel) {
            $rt_addContract(this, cec88372874868d65bd05d6a88c713cddc, "data.ts(56,14)");
            $rt_addContract(otherLabel, cec88372874868d65bd05d6a88c713cddc, "data.ts(57,22)");
            var m = this.length();
        ...
        Label.prototype.equal = function (otherLabel) {
            $rt_addContract(this, cec88372874868d65bd05d6a88c713cddc, "data.ts(71,14)");
            $rt_addContract(otherLabel, cec88372874868d65bd05d6a88c713cddc, "data.ts(72,19)");
            return (this.length() == otherLabel.length()) &&
                (this.isPrefix(otherLabel));
        };
        Label.prototype.isEmpty = function () {
            $rt_addContract(this, cec88372874868d65bd05d6a88c713cddc, "data.ts(75,14)");
            return this.i >= this.j;
        };
        Label.prototype.toString = function () {
            $rt_addContract(this, cec88372874868d65bd05d6a88c713cddc, "data.ts(78,14)");
            return this.datum.substr(this.i, this.j);
        };
        Label.prototype.toStringRemovingSentinel = function () {
            $rt_addContract(this, cec88372874868d65bd05d6a88c713cddc, "data.ts(81,14)");
            return this.datum.substr(this.i, Math.min(this.j, this.datum.length - 1));
        };
        Label.prototype.copy = function () {
            $rt_addContract(this, cec88372874868d65bd05d6a88c713cddc, "data.ts(84,14)");
            return new Label(this.datum, this.i, this.j);
        };
        Label.prototype.labelRefAtEnd = function (offset) {
            $rt_addContract(this, cec88372874868d65bd05d6a88c713cddc, "data.ts(87,14)");
            $rt_check(offset, "number");
            return this.length() == offset;
        };
        Label.prototype.isSourceEqual = function (otherLabel) {
            $rt_addContract(this, cec88372874868d65bd05d6a88c713cddc, "data.ts(90,14)");
            $rt_addContract(otherLabel, cec88372874868d65bd05d6a88c713cddc, "data.ts(91,27)");
    ...
    var SuffixTree = (function () {
        function SuffixTree() {
            $rt_addContract(this, c039618a25fe49bc46e3571a10332d667c, "data.ts(96,26)");
    ...
    function deepCopyLabelSTNodeArray(a) {
        $rt_addContract(a, c84fb510a892c3bfcd3fbde636cfc1fdcc, "data.ts(103,43)");
        var ret = [];
    ...
    var STNode = (function () {
        function STNode(iUpLabel, iParent, iChildren, iSuffixLink) {
            $rt_addContract(this, c1919ec94bf6e77835438f19b15184bdbc, "data.ts(117,26)");
            $rt_addContract(iUpLabel, cec88372874868d65bd05d6a88c713cddc, "data.ts(118,25)");
            $rt_addContract(iParent, c1919ec94bf6e77835438f19b15184bdbc, "data.ts(118,41)");
            $rt_addContract(iChildren, c84fb510a892c3bfcd3fbde636cfc1fdcc, "data.ts(118,58)");
            $rt_addContract(iSuffixLink, c1919ec94bf6e77835438f19b15184bdbc, "data.ts(118,79)");
            //
            this.upLabel = iUpLabel;
            this.parent = iParent;
            this.children = iChildren;
            this.suffixLink = iSuffixLink;
            $rt_check(this.spID = nodeID, "number");
            nodeID++;
        }
        STNode.prototype.simpleStr = function () {
            $rt_addContract(this, c1919ec94bf6e77835438f19b15184bdbc, "data.ts(126,14)");
        ...
        STNode.prototype.nodeRoot = function () {
            $rt_addContract(this, c1919ec94bf6e77835438f19b15184bdbc, "data.ts(129,14)");
            return this.parent == undefined;
        };
        // returns the leaf
        STNode.prototype.addLeafBang = function (iLabel) {
            $rt_addContract(this, c1919ec94bf6e77835438f19b15184bdbc, "data.ts(133,14)");
            $rt_addContract(iLabel, cec88372874868d65bd05d6a88c713cddc, "data.ts(135,25)");
            var leaf = new STNode(iLabel, this, [], undefined);
            this.addChildBang(leaf);
            return leaf;
        };
        STNode.prototype.addChildBang = function (iNode) {
            $rt_addContract(this, c1919ec94bf6e77835438f19b15184bdbc, "data.ts(139,14)");
            $rt_addContract(iNode, c1919ec94bf6e77835438f19b15184bdbc, "data.ts(140,26)");
            this.children.push(iNode);
        };
        STNode.prototype.removeChildBang = function (iChild) {
            $rt_addContract(this, c1919ec94bf6e77835438f19b15184bdbc, "data.ts(142,14)");
            $rt_addContract(iChild, c1919ec94bf6e77835438f19b15184bdbc, "data.ts(143,29)");
            var theIndex = this.children.indexOf(iChild);
            this.children.splice(theIndex, 1);
        };
        STNode.prototype.isLeaf = function () {
            $rt_addContract(this, c1919ec94bf6e77835438f19b15184bdbc, "data.ts(146,14)");
            return this.children.length == 0;
        };
        // produces undefined if nothing can be found
        STNode.prototype.findChild = function (toFind) {
            $rt_addContract(this, c1919ec94bf6e77835438f19b15184bdbc, "data.ts(149,14)");
        ...
        STNode.prototype.upSplit = function (offset) {
            $rt_addContract(this, c1919ec94bf6e77835438f19b15184bdbc, "data.ts(170,14)");
            $rt_check(offset, "number");
        ...
        STNode.prototype.upSpliceLeaf = function (offset, leafLabel) {
            $rt_addContract(this, c1919ec94bf6e77835438f19b15184bdbc, "data.ts(183,14)");
            $rt_check(offset, "number");
        ...
        STNode.prototype.nodeFollowK = function (originalLabel, matnK, mateK, misnK, miseK) {
            $rt_addContract(this, c1919ec94bf6e77835438f19b15184bdbc, "data.ts(189,14)");
            $rt_addContract(originalLabel, cec88372874868d65bd05d6a88c713cddc, "data.ts(190,25)");
        ...
        STNode.prototype.positionAtEnd = function (offset) {
            $rt_addContract(this, c1919ec94bf6e77835438f19b15184bdbc, "data.ts(225,14)");
            $rt_check(offset, "number");
