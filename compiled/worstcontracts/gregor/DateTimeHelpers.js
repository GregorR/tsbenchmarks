...
(function (DateTimeHelpers) {
    function datetime_equal_proc(d1, d2) {
        $rt_addContract(d1, c185d0e943cabad3e294825d3b5c26f96c, "/home/gkrichar/research/projects/ongoing/vm-gradual-typing/tsbenchmarks/compiled/worstcontracts/gregor/DateTimeHelpers.ts(11,45)");
        $rt_addContract(d2, c185d0e943cabad3e294825d3b5c26f96c, "/home/gkrichar/research/projects/ongoing/vm-gradual-typing/tsbenchmarks/compiled/worstcontracts/gregor/DateTimeHelpers.ts(11,60)");
    ...
    function datetime_hash_proc(x, fn) {
        $rt_addContract(x, c185d0e943cabad3e294825d3b5c26f96c, "/home/gkrichar/research/projects/ongoing/vm-gradual-typing/tsbenchmarks/compiled/worstcontracts/gregor/DateTimeHelpers.ts(14,44)");
        return fn(x.jd);
    }
    ...
    function datetime_write_proc(d) {
        $rt_addContract(d, c185d0e943cabad3e294825d3b5c26f96c, "/home/gkrichar/research/projects/ongoing/vm-gradual-typing/tsbenchmarks/compiled/worstcontracts/gregor/DateTimeHelpers.ts(19,45)");
    ...
    function dateTime_to_date(d) {
        $rt_addContract(d, c185d0e943cabad3e294825d3b5c26f96c, "/home/gkrichar/research/projects/ongoing/vm-gradual-typing/tsbenchmarks/compiled/worstcontracts/gregor/DateTimeHelpers.ts(25,42)");
        return d.date;
    }
    DateTimeHelpers.dateTime_to_date = dateTime_to_date;
    function dateTime_to_time(d) {
        $rt_addContract(d, c185d0e943cabad3e294825d3b5c26f96c, "/home/gkrichar/research/projects/ongoing/vm-gradual-typing/tsbenchmarks/compiled/worstcontracts/gregor/DateTimeHelpers.ts(28,42)");
        return d.time;
    }
    DateTimeHelpers.dateTime_to_time = dateTime_to_time;
    function dateTime_to_jd(d) {
        if (isDateTime(d)) {
            return ($rt_addContract(d, c185d0e943cabad3e294825d3b5c26f96c, "/home/gkrichar/research/projects/ongoing/vm-gradual-typing/tsbenchmarks/compiled/worstcontracts/gregor/DateTimeHelpers.ts(33,25)")).jd;
        }
        else
    ...
    function posix_to_dateTime(p) {
        $rt_addContract(p, cb428ee35dde1daf8172dc14bf3090eabc, "/home/gkrichar/research/projects/ongoing/vm-gradual-typing/tsbenchmarks/compiled/worstcontracts/gregor/DateTimeHelpers.ts(46,43)");
    ...
    function date_and_time_to_dateTime(d, t) {
        $rt_addContract(d, c88c4fc9dc6ad49b94a0acac0da2a67adc, "/home/gkrichar/research/projects/ongoing/vm-gradual-typing/tsbenchmarks/compiled/worstcontracts/gregor/DateTimeHelpers.ts(49,51)");
        $rt_addContract(t, c9ef09708d50df0c2e65c55893ccf3b54c, "/home/gkrichar/research/projects/ongoing/vm-gradual-typing/tsbenchmarks/compiled/worstcontracts/gregor/DateTimeHelpers.ts(49,61)");
    ...
    function datetime(year, month, day, hour, minute, second, nano) {
        ...
        $rt_check(year, "number");
        $rt_check(day, "number");
        $rt_check(second, "number");
        $rt_check(nano, "number");
    ...
    function datetime_to_iso8601(d) {
        $rt_addContract(d, c185d0e943cabad3e294825d3b5c26f96c, "/home/gkrichar/research/projects/ongoing/vm-gradual-typing/tsbenchmarks/compiled/worstcontracts/gregor/DateTimeHelpers.ts(62,45)");
    ...
    function date_and_time_to_jd(d, t) {
        $rt_addContract(d, c88c4fc9dc6ad49b94a0acac0da2a67adc, "/home/gkrichar/research/projects/ongoing/vm-gradual-typing/tsbenchmarks/compiled/worstcontracts/gregor/DateTimeHelpers.ts(67,45)");
        $rt_addContract(t, c9ef09708d50df0c2e65c55893ccf3b54c, "/home/gkrichar/research/projects/ongoing/vm-gradual-typing/tsbenchmarks/compiled/worstcontracts/gregor/DateTimeHelpers.ts(67,55)");
    ...
    function jd_to_date_and_time(jd) {
        $rt_addContract(jd, cb428ee35dde1daf8172dc14bf3090eabc, "/home/gkrichar/research/projects/ongoing/vm-gradual-typing/tsbenchmarks/compiled/worstcontracts/gregor/DateTimeHelpers.ts(74,45)");
        var jdn = jd_to_jdn(jd).ieEval();
        var d = DateHelpers_1.DateHelpers.jdn_to_date(jdn);
        var day_ns = $rt_check(jd_to_day_ns(jd), "number");
    ...
    function jd_to_jdn(jd) {
        $rt_addContract(jd, cb428ee35dde1daf8172dc14bf3090eabc, "/home/gkrichar/research/projects/ongoing/vm-gradual-typing/tsbenchmarks/compiled/worstcontracts/gregor/DateTimeHelpers.ts(81,35)");
    ...
    function jd_to_day_ns(jd) {
        ...
        var frac = $rt_addContract(base.add(new CoreClasses_1.CoreClasses.ExactRational(Math.floor(base.ieEval()), 1)), cb428ee35dde1daf8172dc14bf3090eabc, "/home/gkrichar/research/projects/ongoing/vm-gradual-typing/tsbenchmarks/compiled/worstcontracts/gregor/DateTimeHelpers.ts(98,40)");
        var r = round(frac.ieEval() * (new HMSN_1.HMSN.Consts()).NS_DAY);
        return r;
    }
    DateTimeHelpers.jd_to_day_ns = jd_to_day_ns;
    function jd_to_posix(jd) {
        $rt_addContract(jd, cb428ee35dde1daf8172dc14bf3090eabc, "/home/gkrichar/research/projects/ongoing/vm-gradual-typing/tsbenchmarks/compiled/worstcontracts/gregor/DateTimeHelpers.ts(102,37)");
    ...
    function posix_to_jd(posix) {
        $rt_addContract(posix, cb428ee35dde1daf8172dc14bf3090eabc, "/home/gkrichar/research/projects/ongoing/vm-gradual-typing/tsbenchmarks/compiled/worstcontracts/gregor/DateTimeHelpers.ts(105,37)");
    ...
    function dateTime_add_nanoseconds(dt, n) {
        $rt_addContract(dt, c185d0e943cabad3e294825d3b5c26f96c, "/home/gkrichar/research/projects/ongoing/vm-gradual-typing/tsbenchmarks/compiled/worstcontracts/gregor/DateTimeHelpers.ts(108,50)");
        $rt_check(n, "number");
    ...
    function dateTime_add_seconds(dt, n) {
        $rt_addContract(dt, c185d0e943cabad3e294825d3b5c26f96c, "/home/gkrichar/research/projects/ongoing/vm-gradual-typing/tsbenchmarks/compiled/worstcontracts/gregor/DateTimeHelpers.ts(111,46)");
        $rt_check(n, "number");
