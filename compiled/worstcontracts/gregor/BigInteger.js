...
(function (BigInteger) {
    var BigInt = (function () {
        function BigInt(v) {
            this.arrayValue = [];
            $rt_addContract(this, cba231f20fb6fc388eee39c06308fe87ec, "BigInteger.ts(9,32)");
            this.howDecimal = 0;
            if (v < 0) {
                this.sign = -1;
            }
        ...
        BigInt.prototype.getValue = function () {
            $rt_addContract(this, cba231f20fb6fc388eee39c06308fe87ec, "BigInteger.ts(53,14)");
            var toRet = 0;
        ...
        BigInt.prototype.printable = function () {
            $rt_addContract(this, cba231f20fb6fc388eee39c06308fe87ec, "BigInteger.ts(61,14)");
            var toRet = "";
            if (this.sign == -1) {
                toRet += "-";
            }
        ...
        BigInt.prototype.addWithOffset = function (bi) {
            $rt_addContract(this, cba231f20fb6fc388eee39c06308fe87ec, "BigInteger.ts(76,14)");
            $rt_addContract(bi, cba231f20fb6fc388eee39c06308fe87ec, "BigInteger.ts(79,34)");
            ...
            this.howDecimal = 0;
            bi.howDecimal = 0;
            var res = $rt_addContract(this.add(bi), cba231f20fb6fc388eee39c06308fe87ec, "BigInteger.ts(95,34)");
            bi.howDecimal = hdB;
            this.howDecimal = hdB;
        ...
        BigInt.prototype.remTrailingZeros = function () {
            $rt_addContract(this, cba231f20fb6fc388eee39c06308fe87ec, "BigInteger.ts(102,14)");
            var numExtra = 0;
        ...
        BigInt.prototype.add = function (bi) {
            $rt_addContract(this, cba231f20fb6fc388eee39c06308fe87ec, "BigInteger.ts(110,14)");
            $rt_addContract(bi, cba231f20fb6fc388eee39c06308fe87ec, "BigInteger.ts(111,24)");
        ...
        BigInt.prototype.multiplyWithOffset = function (bi) {
            $rt_addContract(this, cba231f20fb6fc388eee39c06308fe87ec, "BigInteger.ts(145,14)");
            $rt_addContract(bi, cba231f20fb6fc388eee39c06308fe87ec, "BigInteger.ts(146,39)");
        ...
        BigInt.prototype.neg = function () {
            $rt_addContract(this, cba231f20fb6fc388eee39c06308fe87ec, "BigInteger.ts(159,14)");
        ...
        BigInt.prototype.divide = function (bi) {
            $rt_addContract(this, cba231f20fb6fc388eee39c06308fe87ec, "BigInteger.ts(169,14)");
            $rt_addContract(bi, cba231f20fb6fc388eee39c06308fe87ec, "BigInteger.ts(170,27)");
            ...
            var curMult = $rt_addContract((new BigInt(2)).add(d.neg()), cba231f20fb6fc388eee39c06308fe87ec, "BigInteger.ts(187,38)");
            var intGarb = curMult.multiply(d);
            curMult = curMult.multiply(x);
            for (var i = 0; i < 6; i++) {
                var intGarb2 = $rt_addContract((new BigInt(2)).add(intGarb.neg()), cba231f20fb6fc388eee39c06308fe87ec, "BigInteger.ts(191,43)");
        ...
        BigInt.prototype.multiply = function (bi) {
            $rt_addContract(this, cba231f20fb6fc388eee39c06308fe87ec, "BigInteger.ts(198,14)");
            $rt_addContract(bi, cba231f20fb6fc388eee39c06308fe87ec, "BigInteger.ts(199,29)");
            if (this.howDecimal > 0 || bi.howDecimal > 0) {
            ...
            for (var i = 0; i < this.arrayValue.length; i++) {
                ...
                $rt_addContract(sum = sum.add(curToAdd), cba231f20fb6fc388eee39c06308fe87ec, "BigInteger.ts(216,73)");
            }
            sum.sign = bi.sign * this.sign;
        ...
        BigInt.prototype.sub = function (bi) {
            $rt_addContract(this, cba231f20fb6fc388eee39c06308fe87ec, "BigInteger.ts(222,14)");
            var toRet = new BigInt(0);
        ...
        BigInt.prototype.trimZeros = function () {
            $rt_addContract(this, cba231f20fb6fc388eee39c06308fe87ec, "BigInteger.ts(231,14)");
            var newAr = [];
            var i = 0;
        ...
        BigInt.prototype.getRidOf10s = function () {
            $rt_addContract(this, cba231f20fb6fc388eee39c06308fe87ec, "BigInteger.ts(242,14)");
