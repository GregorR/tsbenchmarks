...
export module TimeHelpers {
        export function time_hash_proc(x: D.Time, fn: (n: number) => number): any {
            return fn(x.ns);
        }
        ...
        export function date_write_proc(d: D.Time): any {
        ...
        export function time(h: number, m: any = 0, s = 0, n: any = 0): D.Time {
