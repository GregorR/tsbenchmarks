...
export module DateHelpers {
        export function date_hash_proc(x: D.Date, fn: (n: number) => number): any {
            return fn(x.jdn);
        }
        ...
        export function date_write_proc(d: D.Date): any {
        ...
        export function ymd_to_date(ymd: any): D.Date {
            return date(ymd.y, ymd.m, ymd.d);
        }
        export function jdn_to_date(jdn: any): D.Date {
        ...
        function f(n: any, len: number): string {
            var instr: any = n + "";
            var curLen: any = instr.length;
