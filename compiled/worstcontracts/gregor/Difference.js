...
(function (Difference) {
    function datetime_months_between(dt1, dt2) {
        $rt_addContract(dt1, c185d0e943cabad3e294825d3b5c26f96c, "Difference.ts(14,49)");
        $rt_addContract(dt2, c185d0e943cabad3e294825d3b5c26f96c, "Difference.ts(14,65)");
        if (dt2.lt(dt1)) {
    ...
    function dateTime_days_between(dt1, dt2) {
        $rt_addContract(dt1, c185d0e943cabad3e294825d3b5c26f96c, "Difference.ts(38,47)");
        $rt_addContract(dt2, c185d0e943cabad3e294825d3b5c26f96c, "Difference.ts(38,63)");
    ...
    function dateTime_nanoseconds_between(dt1, dt2) {
        $rt_addContract(dt1, c185d0e943cabad3e294825d3b5c26f96c, "Difference.ts(41,54)");
        $rt_addContract(dt2, c185d0e943cabad3e294825d3b5c26f96c, "Difference.ts(41,70)");
        ...
        var toRet = $rt_addContract(bi2.sub(bi1), cba231f20fb6fc388eee39c06308fe87ec, "Difference.ts(46,34)");
        return toRet.getValue();
    }
    Difference.dateTime_nanoseconds_between = dateTime_nanoseconds_between;
    function dateTime_to_jdns(dt) {
        $rt_addContract(dt, c185d0e943cabad3e294825d3b5c26f96c, "Difference.ts(49,42)");
        ...
        var end = $rt_addContract(intFrac.multiply(new BigInteger_1.BigInteger.BigInt(c.NS_DAY)), cba231f20fb6fc388eee39c06308fe87ec, "Difference.ts(55,32)");
        return end.getValue();
    }
