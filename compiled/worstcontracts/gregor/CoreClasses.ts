...
export module CoreClasses {
        ...
        export class ExactRational {
            ...
            public divide(e: any): ExactRational {
                // a/b / c/d = ad / bc
                var newNum = this.num * e.denom;
                var newDenom: any = this.denom * e.num;
        ...
        export class HMSN {
            ...
            s: number;
            n: number;
            constructor(ht: number, mt: number, st: any, nt: number) {
                this.h = ht;
                this.m = mt;
                this.s = st;
                this.n = nt;
        ...
        export class Moment {
            ...
            public moment_to_iso8601(m: Moment): string {
                ...
                var sign: any = m.UTCOffset < 0 ? "-" : "+";
                var sec: any = Math.abs(m.UTCOffset);
                var hrs: any = Math.floor(sec / 3600);
