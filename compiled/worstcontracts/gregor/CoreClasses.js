...
(function (CoreClasses) {
    var Pair = (function () {
        function Pair(tx, ty) {
            $rt_addContract(this, c2a02e0ed7f0f2f04419c984bc1c284ccc, "CoreClasses.ts(9,18)");
            this.x = tx;
            this.y = ty;
        }
        return Pair;
    ...
    var ExactRational = (function () {
        function ExactRational(n, d) {
            $rt_addContract(this, cb428ee35dde1daf8172dc14bf3090eabc, "CoreClasses.ts(18,27)");
            $rt_check(n, "number");
        ...
        ExactRational.prototype.reduce = function () {
            $rt_addContract(this, cb428ee35dde1daf8172dc14bf3090eabc, "CoreClasses.ts(27,14)");
        ...
        ExactRational.prototype.gcd = function (a, b) {
            $rt_addContract(this, cb428ee35dde1daf8172dc14bf3090eabc, "CoreClasses.ts(32,14)");
            $rt_check(a, "number");
            $rt_check(b, "number");
            return b ? this.gcd(b, a % b) : a;
        };
        ExactRational.prototype.ieEval = function () {
            $rt_addContract(this, cb428ee35dde1daf8172dc14bf3090eabc, "CoreClasses.ts(35,14)");
            return this.num / (this.denom + 0.0);
        };
        ExactRational.prototype.add = function (e) {
            $rt_addContract(this, cb428ee35dde1daf8172dc14bf3090eabc, "CoreClasses.ts(38,14)");
            $rt_addContract(e, cb428ee35dde1daf8172dc14bf3090eabc, "CoreClasses.ts(39,24)");
        ...
        ExactRational.prototype.divide = function (e) {
            $rt_addContract(this, cb428ee35dde1daf8172dc14bf3090eabc, "CoreClasses.ts(44,14)");
            // a/b / c/d = ad / bc
        ...
        ExactRational.prototype.mul = function (e) {
            $rt_addContract(this, cb428ee35dde1daf8172dc14bf3090eabc, "CoreClasses.ts(50,14)");
            $rt_addContract(e, cb428ee35dde1daf8172dc14bf3090eabc, "CoreClasses.ts(51,24)");
            return new ExactRational(this.num * e.num, this.denom * e.denom);
        };
        ExactRational.prototype.equals = function (e) {
            $rt_addContract(this, cb428ee35dde1daf8172dc14bf3090eabc, "CoreClasses.ts(53,14)");
            $rt_addContract(e, cb428ee35dde1daf8172dc14bf3090eabc, "CoreClasses.ts(54,27)");
            return (this.num == e.num && this.denom == e.denom);
        };
        ExactRational.prototype.lt = function (e) {
            $rt_addContract(this, cb428ee35dde1daf8172dc14bf3090eabc, "CoreClasses.ts(56,14)");
            $rt_addContract(e, cb428ee35dde1daf8172dc14bf3090eabc, "CoreClasses.ts(57,23)");
            return (this.ieEval() < e.ieEval());
        };
        ExactRational.prototype.lte = function (e) {
            $rt_addContract(this, cb428ee35dde1daf8172dc14bf3090eabc, "CoreClasses.ts(59,14)");
            $rt_addContract(e, cb428ee35dde1daf8172dc14bf3090eabc, "CoreClasses.ts(60,24)");
    ...
    var YMD = (function () {
        function YMD(ty, tm, td) {
            $rt_addContract(this, c9d621ec1593b6269e269fe4abfa7644ac, "CoreClasses.ts(83,23)");
            $rt_check(ty, "number");
            $rt_check(td, "number");
            this.y = ty;
            this.m = tm;
    ...
    var HMSN = (function () {
        function HMSN(ht, mt, st, nt) {
            $rt_addContract(this, ce47d9450624f1d498b2010288b025110c, "CoreClasses.ts(95,23)");
            $rt_check(ht, "number");
            $rt_check(mt, "number");
            $rt_check(nt, "number");
            this.h = ht;
            this.m = mt;
            $rt_check(this.s = st, "number");
            this.n = nt;
        }
        return HMSN;
    }());
    ...
    var Date = (function () {
        function Date(tymd, tdjn) {
            $rt_addContract(this, c88c4fc9dc6ad49b94a0acac0da2a67adc, "CoreClasses.ts(106,25)");
            this.ymd = new YMD(tymd.y, tymd.m, tymd.d);
            $rt_check(this.jdn = tdjn, "number");
        }
        Date.prototype.equals = function (d) {
            $rt_addContract(this, c88c4fc9dc6ad49b94a0acac0da2a67adc, "CoreClasses.ts(110,14)");
            $rt_addContract(d, c88c4fc9dc6ad49b94a0acac0da2a67adc, "CoreClasses.ts(111,27)");
            return (this.jdn == d.jdn);
        };
        Date.prototype.lte = function (d) {
            $rt_addContract(this, c88c4fc9dc6ad49b94a0acac0da2a67adc, "CoreClasses.ts(113,14)");
            $rt_addContract(d, c88c4fc9dc6ad49b94a0acac0da2a67adc, "CoreClasses.ts(114,24)");
            return (this.jdn <= d.jdn);
        };
        return Date;
    }());
    ...
    var Time = (function () {
        function Time(h, n) {
            $rt_addContract(this, c9ef09708d50df0c2e65c55893ccf3b54c, "CoreClasses.ts(121,24)");
            $rt_addContract(h, ce47d9450624f1d498b2010288b025110c, "CoreClasses.ts(122,25)");
            $rt_check(n, "number");
            this.ns = n;
            this.hmsn = h;
        }
        Time.prototype.equals = function (t) {
            $rt_addContract(this, c9ef09708d50df0c2e65c55893ccf3b54c, "CoreClasses.ts(125,14)");
            $rt_addContract(t, c9ef09708d50df0c2e65c55893ccf3b54c, "CoreClasses.ts(126,27)");
            return (this.ns == t.ns);
        };
        Time.prototype.lte = function (t) {
            $rt_addContract(this, c9ef09708d50df0c2e65c55893ccf3b54c, "CoreClasses.ts(128,14)");
            $rt_addContract(t, c9ef09708d50df0c2e65c55893ccf3b54c, "CoreClasses.ts(129,24)");
            return (this.ns <= t.ns);
        };
        Time.prototype.lt = function (t) {
            $rt_addContract(this, c9ef09708d50df0c2e65c55893ccf3b54c, "CoreClasses.ts(131,14)");
            $rt_addContract(t, c9ef09708d50df0c2e65c55893ccf3b54c, "CoreClasses.ts(132,23)");
            return (this.ns < t.ns);
        };
        return Time;
    }());
    ...
    var DateTime = (function () {
        function DateTime(d, t, j) {
            $rt_addContract(this, c185d0e943cabad3e294825d3b5c26f96c, "CoreClasses.ts(140,31)");
            $rt_addContract(d, c88c4fc9dc6ad49b94a0acac0da2a67adc, "CoreClasses.ts(141,25)");
            $rt_addContract(t, c9ef09708d50df0c2e65c55893ccf3b54c, "CoreClasses.ts(141,33)");
            $rt_addContract(j, cb428ee35dde1daf8172dc14bf3090eabc, "CoreClasses.ts(141,42)");
        ...
        DateTime.prototype.equals = function (d) {
            $rt_addContract(this, c185d0e943cabad3e294825d3b5c26f96c, "CoreClasses.ts(145,14)");
            $rt_addContract(d, c185d0e943cabad3e294825d3b5c26f96c, "CoreClasses.ts(146,27)");
            return (this.jd.num == d.jd.num && this.jd.denom == d.jd.denom);
        };
        DateTime.prototype.lt = function (d) {
            $rt_addContract(this, c185d0e943cabad3e294825d3b5c26f96c, "CoreClasses.ts(148,14)");
            $rt_addContract(d, c185d0e943cabad3e294825d3b5c26f96c, "CoreClasses.ts(149,23)");
            return (this.jd.ieEval() < d.jd.ieEval());
        };
        DateTime.prototype.lte = function (d) {
            $rt_addContract(this, c185d0e943cabad3e294825d3b5c26f96c, "CoreClasses.ts(151,14)");
            $rt_addContract(d, c185d0e943cabad3e294825d3b5c26f96c, "CoreClasses.ts(152,24)");
    ...
    var Moment = (function () {
        function Moment(dt, off, z) {
            $rt_addContract(this, ca606bc0b6ddd960bfdef94094110a768c, "CoreClasses.ts(160,26)");
            $rt_addContract(dt, c185d0e943cabad3e294825d3b5c26f96c, "CoreClasses.ts(161,25)");
            $rt_check(off, "number");
            $rt_check(z, "string");
        ...
        Moment.prototype.moment_to_iso8601_tzid = function (m) {
            $rt_addContract(this, ca606bc0b6ddd960bfdef94094110a768c, "CoreClasses.ts(165,14)");
            $rt_addContract(m, ca606bc0b6ddd960bfdef94094110a768c, "CoreClasses.ts(166,43)");
        ...
        Moment.prototype.moment_to_iso8601 = function (m) {
            $rt_addContract(this, ca606bc0b6ddd960bfdef94094110a768c, "CoreClasses.ts(172,14)");
            $rt_addContract(m, ca606bc0b6ddd960bfdef94094110a768c, "CoreClasses.ts(173,38)");
            if (m.UTCOffset == 0) {
        ...
        Moment.prototype.f = function (n, len) {
            $rt_addContract(this, ca606bc0b6ddd960bfdef94094110a768c, "CoreClasses.ts(182,14)");
            $rt_check(n, "number");
            $rt_check(len, "number");
            var instr = n + "";
