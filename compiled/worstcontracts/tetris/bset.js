...
(function (BSet) {
    ...
    function blocksContains(bs, b) {
        $rt_addContract(b, c290d91851cfad63c36229d9ad9ba086bc, "/home/gkrichar/research/projects/ongoing/vm-gradual-typing/tsbenchmarks/compiled/worstcontracts/tetris/bset.ts(14,48)");
    ...
    function isBlocksSubset(bs1, bs2) {
        $rt_addContract(bs1, c3a34e082c24e6e1e3d6df2fbb131820bc, "/home/gkrichar/research/projects/ongoing/vm-gradual-typing/tsbenchmarks/compiled/worstcontracts/tetris/bset.ts(22,33)");
        $rt_addContract(bs2, c3a34e082c24e6e1e3d6df2fbb131820bc, "/home/gkrichar/research/projects/ongoing/vm-gradual-typing/tsbenchmarks/compiled/worstcontracts/tetris/bset.ts(22,51)");
    ...
    function blockSetsEqual(bs1, bs2) {
        $rt_addContract(bs1, c3a34e082c24e6e1e3d6df2fbb131820bc, "/home/gkrichar/research/projects/ongoing/vm-gradual-typing/tsbenchmarks/compiled/worstcontracts/tetris/bset.ts(30,40)");
        $rt_addContract(bs2, c3a34e082c24e6e1e3d6df2fbb131820bc, "/home/gkrichar/research/projects/ongoing/vm-gradual-typing/tsbenchmarks/compiled/worstcontracts/tetris/bset.ts(30,58)");
    ...
    function blocksIntersect(bs1, bs2) {
        $rt_addContract(bs1, c3a34e082c24e6e1e3d6df2fbb131820bc, "/home/gkrichar/research/projects/ongoing/vm-gradual-typing/tsbenchmarks/compiled/worstcontracts/tetris/bset.ts(34,41)");
        $rt_addContract(bs2, c3a34e082c24e6e1e3d6df2fbb131820bc, "/home/gkrichar/research/projects/ongoing/vm-gradual-typing/tsbenchmarks/compiled/worstcontracts/tetris/bset.ts(34,59)");
        var r = [];
        for (var i = 0; i < blocksCount(bs1); i++) {
            if (blocksContains(bs2, bs1[i])) {
                r.push(bs1[i]);
    ...
    function blocksMove(dx, dy, bs) {
        $rt_check(dy, "number");
        $rt_addContract(bs, c3a34e082c24e6e1e3d6df2fbb131820bc, "/home/gkrichar/research/projects/ongoing/vm-gradual-typing/tsbenchmarks/compiled/worstcontracts/tetris/bset.ts(48,56)");
        for (var i = 0; i < blocksCount(bs); i++) {
            $rt_addContract(bs[i] = block_1.Block.blockMove(dx, dy, bs[i]), c290d91851cfad63c36229d9ad9ba086bc, "/home/gkrichar/research/projects/ongoing/vm-gradual-typing/tsbenchmarks/compiled/worstcontracts/tetris/bset.ts(49,64)");
        }
    }
    BSet.blocksMove = blocksMove;
    // rotate all blocks ccw
    function blocksRotateCCW(c, bs) {
        $rt_addContract(c, c04f0ab873211cfdea36376604bb18379c, "/home/gkrichar/research/projects/ongoing/vm-gradual-typing/tsbenchmarks/compiled/worstcontracts/tetris/bset.ts(54,41)");
        $rt_addContract(bs, c3a34e082c24e6e1e3d6df2fbb131820bc, "/home/gkrichar/research/projects/ongoing/vm-gradual-typing/tsbenchmarks/compiled/worstcontracts/tetris/bset.ts(54,54)");
        for (var i = 0; i < blocksCount(bs); i++) {
    ...
    function blocksRotateCW(c, bs) {
        $rt_addContract(c, c04f0ab873211cfdea36376604bb18379c, "/home/gkrichar/research/projects/ongoing/vm-gradual-typing/tsbenchmarks/compiled/worstcontracts/tetris/bset.ts(60,40)");
        $rt_addContract(bs, c3a34e082c24e6e1e3d6df2fbb131820bc, "/home/gkrichar/research/projects/ongoing/vm-gradual-typing/tsbenchmarks/compiled/worstcontracts/tetris/bset.ts(60,53)");
        for (var i = 0; i < blocksCount(bs); i++) {
    ...
    function blocksChangeColor(bs, c) {
        $rt_addContract(c, c64668cd20c6065e4f7b603c86e86615cc, "/home/gkrichar/research/projects/ongoing/vm-gradual-typing/tsbenchmarks/compiled/worstcontracts/tetris/bset.ts(67,51)");
        for (var i = 0; i < blocksCount(bs); i++) {
    ...
    function blocksRow(bs, i) {
        $rt_addContract(bs, c3a34e082c24e6e1e3d6df2fbb131820bc, "/home/gkrichar/research/projects/ongoing/vm-gradual-typing/tsbenchmarks/compiled/worstcontracts/tetris/bset.ts(73,35)");
        $rt_check(i, "number");
        var r = [];
    ...
    function isFullRow(bs, i) {
        $rt_addContract(bs, c3a34e082c24e6e1e3d6df2fbb131820bc, "/home/gkrichar/research/projects/ongoing/vm-gradual-typing/tsbenchmarks/compiled/worstcontracts/tetris/bset.ts(83,35)");
        $rt_check(i, "number");
    ...
    function isBlocksOverflow(bs) {
        $rt_addContract(bs, c3a34e082c24e6e1e3d6df2fbb131820bc, "/home/gkrichar/research/projects/ongoing/vm-gradual-typing/tsbenchmarks/compiled/worstcontracts/tetris/bset.ts(87,35)");
        for (var i = 0; i < blocksCount(bs); i++) {
            if (bs[i].y <= 0)
                return true;
        }
    ...
    function blocksUnion(bs1, bs2) {
        $rt_addContract(bs1, c3a34e082c24e6e1e3d6df2fbb131820bc, "/home/gkrichar/research/projects/ongoing/vm-gradual-typing/tsbenchmarks/compiled/worstcontracts/tetris/bset.ts(95,37)");
        $rt_addContract(bs2, c3a34e082c24e6e1e3d6df2fbb131820bc, "/home/gkrichar/research/projects/ongoing/vm-gradual-typing/tsbenchmarks/compiled/worstcontracts/tetris/bset.ts(95,55)");
        var r = bs1;
    ...
    function blocksMaxY(bs) {
        $rt_addContract(bs, c3a34e082c24e6e1e3d6df2fbb131820bc, "/home/gkrichar/research/projects/ongoing/vm-gradual-typing/tsbenchmarks/compiled/worstcontracts/tetris/bset.ts(105,36)");
    ...
    function blocksMinX(bs) {
        $rt_addContract(bs, c3a34e082c24e6e1e3d6df2fbb131820bc, "/home/gkrichar/research/projects/ongoing/vm-gradual-typing/tsbenchmarks/compiled/worstcontracts/tetris/bset.ts(114,36)");
    ...
    function blocksMaxX(bs) {
        $rt_addContract(bs, c3a34e082c24e6e1e3d6df2fbb131820bc, "/home/gkrichar/research/projects/ongoing/vm-gradual-typing/tsbenchmarks/compiled/worstcontracts/tetris/bset.ts(123,36)");
