...
(function (World) {
    ...
    function didLandedOnBlocks(w) {
        $rt_addContract(w, c7773aab651f02141fc60153c16bd4560c, "/home/gkrichar/research/projects/ongoing/vm-gradual-typing/tsbenchmarks/compiled/worstcontracts/tetris/world.ts(21,36)");
    ...
    function didLandedOnFloor(w) {
        $rt_addContract(w, c7773aab651f02141fc60153c16bd4560c, "/home/gkrichar/research/projects/ongoing/vm-gradual-typing/tsbenchmarks/compiled/worstcontracts/tetris/world.ts(26,35)");
        return bset_1.BSet.blocksMaxY(w.tetra.blocks) == (consts_1.Consts.boardHeight - 1);
    }
    function didLanded(w) {
        $rt_addContract(w, c7773aab651f02141fc60153c16bd4560c, "/home/gkrichar/research/projects/ongoing/vm-gradual-typing/tsbenchmarks/compiled/worstcontracts/tetris/world.ts(29,28)");
        return didLandedOnFloor(w) || didLandedOnBlocks(w);
    }
    // take current tetra and move it down until it lands
    function worldJumpDown(w) {
        $rt_addContract(w, c7773aab651f02141fc60153c16bd4560c, "/home/gkrichar/research/projects/ongoing/vm-gradual-typing/tsbenchmarks/compiled/worstcontracts/tetris/world.ts(33,32)");
        if (didLanded(w)) {
            // do nothing
        }
        else {
    ...
    function nextWorld(w) {
        $rt_addContract(w, c7773aab651f02141fc60153c16bd4560c, "/home/gkrichar/research/projects/ongoing/vm-gradual-typing/tsbenchmarks/compiled/worstcontracts/tetris/world.ts(44,35)");
        if (didLanded(w)) {
            touchdown(w);
        }
        else {
    ...
    function worldMove(dx, dy, w) {
        $rt_check(dy, "number");
        $rt_addContract(w, c7773aab651f02141fc60153c16bd4560c, "/home/gkrichar/research/projects/ongoing/vm-gradual-typing/tsbenchmarks/compiled/worstcontracts/tetris/world.ts(64,48)");
        var tmpTetra = data_1.Data.tetraCopy(w.tetra);
    ...
    function worldRotateCCW(w) {
        $rt_addContract(w, c7773aab651f02141fc60153c16bd4560c, "/home/gkrichar/research/projects/ongoing/vm-gradual-typing/tsbenchmarks/compiled/worstcontracts/tetris/world.ts(70,33)");
        var tmpTetra = data_1.Data.tetraCopy(w.tetra);
        tetras_1.Tetras.tetraRotateCCW(tmpTetra);
        tryNewTetra(w, tmpTetra);
    }
    function worldRotateCW(w) {
        $rt_addContract(w, c7773aab651f02141fc60153c16bd4560c, "/home/gkrichar/research/projects/ongoing/vm-gradual-typing/tsbenchmarks/compiled/worstcontracts/tetris/world.ts(75,32)");
        var tmpTetra = data_1.Data.tetraCopy(w.tetra);
        tetras_1.Tetras.tetraRotateCW(tmpTetra);
        tryNewTetra(w, tmpTetra);
    }
    function ghostBlocks(w) {
        $rt_addContract(w, c7773aab651f02141fc60153c16bd4560c, "/home/gkrichar/research/projects/ongoing/vm-gradual-typing/tsbenchmarks/compiled/worstcontracts/tetris/world.ts(80,37)");
        var tmpTetra = data_1.Data.tetraCopy(w.tetra);
    ...
    function worldKeyMove(w, k) {
        $rt_addContract(w, c7773aab651f02141fc60153c16bd4560c, "/home/gkrichar/research/projects/ongoing/vm-gradual-typing/tsbenchmarks/compiled/worstcontracts/tetris/world.ts(90,38)");
        switch (k) {
            case "left": {
