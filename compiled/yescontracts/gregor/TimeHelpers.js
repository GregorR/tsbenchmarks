...
(function (TimeHelpers) {
    function time_hash_proc(x, fn) {
        $rt_addContract(x, c9ef09708d50df0c2e65c55893ccf3b54c, "/home/gkrichar/research/projects/ongoing/vm-gradual-typing/tsbenchmarks/gregor/TimeHelpers.ts(15,32)");
        return fn(x.ns);
    }
    ...
    function date_write_proc(d) {
        $rt_addContract(d, c9ef09708d50df0c2e65c55893ccf3b54c, "/home/gkrichar/research/projects/ongoing/vm-gradual-typing/tsbenchmarks/gregor/TimeHelpers.ts(22,33)");
        console.log("<time " + time_to_iso8601(d) + ">");
    }
    TimeHelpers.date_write_proc = date_write_proc;
    function time_to_hmsn(t) {
        $rt_addContract(t, c9ef09708d50df0c2e65c55893ccf3b54c, "/home/gkrichar/research/projects/ongoing/vm-gradual-typing/tsbenchmarks/gregor/TimeHelpers.ts(26,30)");
        return t.hmsn;
    }
    ...
    function hmsn_to_time(hmsn) {
        $rt_addContract(hmsn, ce47d9450624f1d498b2010288b025110c, "/home/gkrichar/research/projects/ongoing/vm-gradual-typing/tsbenchmarks/gregor/TimeHelpers.ts(38,30)");
    ...
    function time_to_iso8601(t) {
        $rt_addContract(t, c9ef09708d50df0c2e65c55893ccf3b54c, "/home/gkrichar/research/projects/ongoing/vm-gradual-typing/tsbenchmarks/gregor/TimeHelpers.ts(63,33)");
        var h = t.hmsn.h;
        var m = t.hmsn.m;
        var s = t.hmsn.s;
        var n = t.hmsn.n;
