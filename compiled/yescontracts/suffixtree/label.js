...
(function (Label) {
    ...
    function catenateStrings(inVals) {
        $rt_addContract(inVals, c662ea7dc8a9f859acf376aa67873938fc, "label.ts(30,26)");
        var ret = "";
    ...
    function vectorToLabel(inVal) {
        $rt_addContract(inVal, c662ea7dc8a9f859acf376aa67873938fc, "label.ts(38,31)");
    ...
    function vectorToLabelWithSentinel(inVal) {
        $rt_addContract(inVal, c662ea7dc8a9f859acf376aa67873938fc, "label.ts(44,43)");
        var theDatum = catenateStrings(inVal);
