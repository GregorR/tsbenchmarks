...
(function (Aux) {
    ...
    var RandGen = (function () {
        function RandGen(s) {
            $rt_addContract(this, c92ce9822a9992ffa5880a38deccd6e7dc, "aux.ts(9,15)");
            $rt_check(s, "number");
            this.setSeed(s);
        }
        RandGen.prototype.setSeed = function (s) {
            $rt_addContract(this, c92ce9822a9992ffa5880a38deccd6e7dc, "aux.ts(13,3)");
            $rt_check(s, "number");
        ...
        RandGen.prototype.random = function () {
            $rt_addContract(this, c92ce9822a9992ffa5880a38deccd6e7dc, "aux.ts(23,3)");
    ...
    function listPickRandom(ls) {
        $rt_addContract(ls, cbc1575c98a59fba705e5c25273a47c41c, "aux.ts(35,32)");
