...
(function (Tetras) {
    ...
    function tetraMove(dx, dy, t) {
        $rt_check(dx, "number");
        $rt_check(dy, "number");
        $rt_addContract(t, c69ba9077056386ee23242c7218820fdec, "/home/gkrichar/research/projects/ongoing/vm-gradual-typing/tsbenchmarks/tetris/typed/tetras.ts(10,53)");
    ...
    function tetraRotateCCW(t) {
        $rt_addContract(t, c69ba9077056386ee23242c7218820fdec, "/home/gkrichar/research/projects/ongoing/vm-gradual-typing/tsbenchmarks/tetris/typed/tetras.ts(18,32)");
    ...
    function tetraRotateCW(t) {
        $rt_addContract(t, c69ba9077056386ee23242c7218820fdec, "/home/gkrichar/research/projects/ongoing/vm-gradual-typing/tsbenchmarks/tetris/typed/tetras.ts(23,31)");
        bset_1.BSet.blocksRotateCW(t.center, t.blocks);
    }
    Tetras.tetraRotateCW = tetraRotateCW;
    // Stub
    function doesTetraOverlapsBlocks(t, bs) {
        $rt_addContract(t, c69ba9077056386ee23242c7218820fdec, "/home/gkrichar/research/projects/ongoing/vm-gradual-typing/tsbenchmarks/tetris/typed/tetras.ts(28,41)");
        $rt_addContract(bs, c3a34e082c24e6e1e3d6df2fbb131820bc, "/home/gkrichar/research/projects/ongoing/vm-gradual-typing/tsbenchmarks/tetris/typed/tetras.ts(28,57)");
    ...
    function tetraChangeColor(t, c) {
        $rt_addContract(t, c69ba9077056386ee23242c7218820fdec, "/home/gkrichar/research/projects/ongoing/vm-gradual-typing/tsbenchmarks/tetris/typed/tetras.ts(33,34)");
        $rt_addContract(c, c64668cd20c6065e4f7b603c86e86615cc, "/home/gkrichar/research/projects/ongoing/vm-gradual-typing/tsbenchmarks/tetris/typed/tetras.ts(33,50)");
    ...
    function buildTetraBlocks(color, xc, yc, x1, y1, x2, y2, x3, y3, x4, y4) {
        $rt_addContract(color, c64668cd20c6065e4f7b603c86e86615cc, "/home/gkrichar/research/projects/ongoing/vm-gradual-typing/tsbenchmarks/tetris/typed/tetras.ts(38,34)");
        $rt_check(xc, "number");
        $rt_check(yc, "number");
        $rt_check(x1, "number");
        $rt_check(y1, "number");
